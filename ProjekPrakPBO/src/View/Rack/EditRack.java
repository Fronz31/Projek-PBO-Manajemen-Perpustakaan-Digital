...
public class EditRack extends JFrame{
    JLabel title = new JLabel("EDIT RACK");
    ...
    String location
        ...
        btnEdit.setBounds(130, 210, 100, 30);

        tfRackName.setText(rackName);
